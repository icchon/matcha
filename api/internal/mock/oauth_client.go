...
// Source: internal/domain/client/oauth.go
//
// Generated by this command:
//
//	mockgen -source=internal/domain/client/oauth.go -destination=internal/mock/oauth_client.go -package=mock
//
...
import (
	...
	client "github.com/icchon/matcha/api/internal/domain/client"
...
func (m *MockOAuthClient) ExchangeCode(ctx context.Context, code, codeVerifier string) (*client.OAuthInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExchangeCode", ctx, code, codeVerifier)
	ret0, _ := ret[0].(*client.OAuthInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
